<?php
	...
	if(isset ($_POST['login']) ){
			...
			if(checkPassword($_POST['strusername'] and $_POST['strpassword'])){
				...
				header("Location: http://localhost/TugasMingguan4/index.php");
				exit();
			}	
	}	
?>
...
<body class="body1">
	...
	<div class="rightbox">
			...
			<img src="./image/dhea.jpg" alt="Dhea" class="img1">
	</div>	
	<table class="tableHome">
		<tr>
			<th>Nama</th><td>Dhea Oky Safitri</td>
		</tr>
		<tr>
			<th>NIM</th><td>170411100006</td>
		</tr>
		<tr>
